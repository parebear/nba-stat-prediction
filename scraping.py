...
def urlSetter(firstName, lastName):
    ...
    # print(rows)
    rows_data = [
        [td.getText() for td in rows[i].findAll("th")] for i in range(len(rows))
    ]
    ...
    if foundPlayer:
        ...
        playerNameUrl = "{}{}01".format(
            lastNameFirstFive.lower(), firstNameFirstTwo.lower()
        )
